class ActionRepairCarEngineWithEpoxyCB : ActionRepairCarEngineCB
{
...
class ActionRepairCarEngineWithEpoxy: ActionRepairCarEngine
{
	void ActionRepairCarEngineWithEpoxy()
	{
	...
	override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
	{
		...
		if (m_LastValidType != target.Type() || m_LastValidComponentIndex != target.GetComponentIndex() || m_CurrentDamageZone == "")
		{
			...
			foreach (string selection : selections)
			{
				...
				{
					if (damageZone == "Engine" || damageZone == "Roof" || damageZone == "Front" || damageZone == "Back" || damageZone == "Fender_1_1" || damageZone == "Fender_1_2" || damageZone == "Fender_2_1" || damageZone == "Fender_2_2" || damageZone == "FuelTank" || damageZone == "Reflector_1_1" || damageZone == "Reflector_1_2" || damageZone == "Reflector_2_1" || damageZone == "Reflector_2_2")
					{
