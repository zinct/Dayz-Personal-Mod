class ARepairSledgeHammer extends RecipeBase {

	override void Init() {
		m_Name = "#STR_RepairSledgeHammer";
		...
		// ingredient 1
		InsertIngredient(0, "SledgeHammer"); // you can insert multiple ingredients this way
