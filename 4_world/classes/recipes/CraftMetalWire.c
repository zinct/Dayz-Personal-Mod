class ACraftMetalWire_CableReel extends RecipeBase {

	override void Init() {
		m_Name = "#STR_craftMetalWire"; // included in vanilla game
		...
		// ingredient 1
		InsertIngredient(0, "CableReel"); // you can insert multiple ingredients this way
		m_MinDamageIngredient[0] = -1; // -1 = disable check, 4 = RUINED, 3 = BADLY_DAMAGED, 2 = DAMAGED, 1 = WORN, 0 = PRISTINE
...
class ACraftMetalWire_XmasLights extends RecipeBase {

	override void Init() {
		m_Name = "#STR_craftMetalWire"; // string included in vanilla game
		m_IsInstaRecipe = false; // should this recipe be performed instantly without animation
		m_AnimationLength = 1; // animation length in relative time units
		m_Specialty = 0.01; // value > 0 for roughness, value < 0 for precision
		...
		// ingredient 1
		InsertIngredient(0, "XmasLights"); // you can insert multiple ingredients this way
		m_MinDamageIngredient[0] = -1; // -1 = disable check, 4 = RUINED, 3 = BADLY_DAMAGED, 2 = DAMAGED, 1 = WORN, 0 = PRISTINE
		m_MaxDamageIngredient[0] = 3; // -1 = disable check, 4 = RUINED, 3 = BADLY_DAMAGED, 2 = DAMAGED, 1 = WORN, 0 = PRISTINE
		m_MinQuantityIngredient[0] = -1; // -1 = disable check
		m_MaxQuantityIngredient[0] = -1; // -1 = disable check
