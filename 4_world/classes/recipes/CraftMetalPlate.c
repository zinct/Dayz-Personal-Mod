class ACraftMetalPlate_Barrel extends RecipeBase {

	override void Init() {
		m_Name = "#STR_CraftMetalPlate";
...
class ACraftMetalPlate_CarDoor extends RecipeBase {
...
class ACraftMetalPlate_PotAndFryingPan extends RecipeBase {
